...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" id="L_pass" name="pwd" required=""
                       autocomplete="off" class="layui-input" lay-verify="newPwd">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" name="pwd" required=""
                       autocomplete="off" class="layui-input" lay-verify="confirmPwd">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <?php if(is_array($group)): foreach($group as $key=>$value): ?><input type="checkbox" name="gid[<?php echo ($value['id']); ?>]" lay-skin="primary" title="<?php echo ($value['title']); ?>"/><?php endforeach; endif; ?>
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(add)', function(data){
            $.post("<?php echo U('Auth/adminAdd');?>",data.field,function(res){
                if(res.code==200) {
