...
<div class="x-body">
    <xblock>
        <button class="layui-btn" onclick="x_admin_show('添加分类','<?php echo U('Bargain/paperStyleAdd');?>',450,250)"><i class="layui-icon"></i>添加分类</button>
    ...
    <script>
        layui.use('table', function(){
            ...
            table.render({
                ...
                ,url: "<?php echo U('Bargain/paperStyle');?>"
                ,cols: [[
                    {field:'bargain_sid', title: 'ID',  align: 'center','sort':true}
                    ,{field:'bargain_style',title: '分类',  align: 'center'}
            ...
            table.on('tool(test)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                ...
                if(layEvent === 'del'){ //删除
                    layer.confirm('确认删除么', function(index){
                        $.post("<?php echo U('Bargain/paperStyleDel');?>",{'id':data.bargain_sid},function(res){
                            if (res.code == 200) {
