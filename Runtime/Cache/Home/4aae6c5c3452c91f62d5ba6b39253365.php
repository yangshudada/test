    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" required="" lay-verify="required" value="<?php echo ($data["title"]); ?>"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="checkbox"  <?php if($data["status"] == 1): ?>checked<?php endif; ?> name="show" lay-skin="switch" lay-filter="switchTest" lay-text="ON|OFF">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <div><input type="hidden" name="ruleid" id="rules" value="<?php echo ($data["rules"]); ?>"></div>
            </div>
        </div>

        <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>" id="ruleid">
        <div class="layui-form-item">
            <label class="layui-form-label">
            </label>
...
<script>
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(edit)', function(data){
            $.post("<?php echo U('Auth/roleEdit');?>",data.field,function(res){
                if(res.code==200) {
