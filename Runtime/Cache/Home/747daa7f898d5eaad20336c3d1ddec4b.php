        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="sid" lay-verify="required">
                    <?php if(is_array($info)): foreach($info as $key=>$value): ?><option value="<?php echo ($value['bargain_sid']); ?>"><?php echo ($value['bargain_style']); ?></option><?php endforeach; endif; ?>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    layui.use(['form','layer','upload'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            $.post("<?php echo U('bargain/paperDetailAdd');?>",data.field,function(res){
                if(res.code==200) {
