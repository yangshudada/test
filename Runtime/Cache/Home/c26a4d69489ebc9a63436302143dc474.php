    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="price_a" required="" lay-verify="required"
        ...
        <input type="hidden" class="" name="style_a" value="<?php echo ($style_a); ?>">
        <input type="hidden" class="" name="style_b" value="<?php echo ($style_b); ?>">
...
<script>
    layui.use(['form','layer','upload'], function(){
        ...
        form.on('submit(add)', function(data){
            $.post("<?php echo U('Test/up_cost_add');?>",data.field,function(res){
                if(res.code==200) {
