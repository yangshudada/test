...
<div class="x-nav">
      <span class="layui-breadcrumb">
        <a>首页</a>
        <a href="<?php echo U('index/vrTypeList');?>">模型类型</a>
      </span>
...
<xblock>
    <button class="layui-btn" onclick="x_admin_show('添加类型','vrTypesAdd.html',500,200)"><i class="layui-icon"></i>添加类型</button>
...
<script>
    layui.use('table', function(){
        ...
        table.render({
            elem: '#LAY_table_user'
            ,url: "<?php echo U('index/vrTypesList');?>"
            ,cols: [[
        ...
        table.on('tool(test)', function(obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'detail') { //查看
                ...
                x_admin_show('编辑类型', "<?php echo U('index/vrTypesEdit');?>?id=" + data.id,500,200);
            }
        });
