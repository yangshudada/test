    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="building" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="<?php echo ($info["house_building"]); ?>">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="type"
                       autocomplete="off" class="layui-input" value="<?php echo ($info["house_type"]); ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="area"
                       autocomplete="off" class="layui-input" value="<?php echo ($info["house_area"]); ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="style"
                       autocomplete="off" class="layui-input" value="<?php echo ($info["house_style"]); ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="number"
                       autocomplete="off" class="layui-input" value="<?php echo ($info["house_number"]); ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-upload-drag" id="test1">
                <div class="images">
                    <?php if($info['house_image'] != ''): ?><img src="<?php echo ($info['house_image']); ?>" style='width:168px;height:70px;'/>
                        <input type='hidden' name='image' value="<?php echo ($info['house_image']); ?>"/>
                        <input type='hidden' name='image_jpg' value="<?php echo ($info['house_image_jpg']); ?>"/>
                        <?php else: ?>
        ...
        <input type="hidden" name="id" value="<?php echo ($info['house_id']); ?>">
...
<script>
    layui.use(['form','layer','upload'], function(){
        ...
        var pro = "<?php echo $info['house_province'];?>";
        var city = "<?php echo $info['house_city'];?>";
        console.log(pro);
        $.get("/company/Public/Resource/city.json", function (data) {
            var proHtml = '';
            for (var i = 0; i < data.length; i++) {
                if(pro==data[i].province) {
                    proHtml += '<option value="' + data[i].province + '" selected>' + data[i].province + '</option>';
                }else{
            ...
            form.render();
            var cityHtml = '<option value="' + city + '" >' + city + '</option>';
                ...
                for (var i = 0; i < msg.length; i++) {
                    if(msg[i].province==data.value){
                        for (var j = 0; j < msg[i].city.length; j++) {
                            if(city==msg[i].city[j].city_name){
                                cityHtml += '<option value="' + msg[i].city[j].city_name + '" selected >' + msg[i].city[j].city_name + '</option>';
                            }else{
        ...
        form.on('submit(edit)', function(data){
            $.post("<?php echo U('House/houseEdit');?>",data.field,function(res){
                if(res.code==200) {
